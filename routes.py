...
# subject = "Your Depression Test Report"
# body = "Hey there! Here is your test report for Depression predction from Blue's Meter"
...
def upload():
    if request.method == 'POST':
        ...
        f.save(secure_filename("tamil_pdff.pdf"))
